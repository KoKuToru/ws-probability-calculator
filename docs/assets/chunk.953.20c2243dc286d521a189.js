"use strict";(globalThis.webpackChunk_ember_auto_import_=globalThis.webpackChunk_ember_auto_import_||[]).push([[953],{462:(e,t,n)=>{function r(e,t,n){return(t="symbol"==typeof(r=function(e,t){if("object"!=typeof e||!e)return e
...
return Object.keys(r).forEach((function(e){i[e]=r[e]})),i.enumerable=!!i.enumerable,i.configurable=!!i.configurable,("value"in i||i.initializer)&&(i.writable=!0),i=n.slice().reverse().reduce((function(n,r){return r(e,t,n)||n}),i),o&&void 0!==i.initializer&&(i.value=i.initializer?i.initializer.call(o):void 0,i.initializer=void 0),void 0===i.initializer&&(Object.defineProperty(e,t,i),i=null),i}n.d(t,{_:()=>i,a:()=>o,b:()=>r})},266:(e,t,n)=>{n.r(t),n.d(t,{default:()=>d})
var r,o,i,s=n(462),a=n(735),c=n(336),l=n.n(c),u=n(666)
...
return this.tokens.push(n),this.tokens.scheduleTitleUpdate(),""}willDestroy(){super.willDestroy(),this.tokens.remove(this.tokenId),this.tokens.scheduleTitleUpdate()}},i=(0,s._)(o.prototype,"tokens",[r],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),o)},299:(e,t,n)=>{n.r(t),n.d(t,{default:()=>y})
var r,o,i,s,a,c=n(462),l=n(604),u=n(735),d=n.n(u),f=n(934),h=n(603)
...
r.appendChild(o),t.appendChild(r)}titleDidUpdate(e){}},s=(0,c._)(i.prototype,"router",[r],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),a=(0,c._)(i.prototype,"document",[o],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),i)},248:(e,t,n)=>{var r=n(614),o=n(392),i=n(470),s=n(106),a=n(175),c=n(675),l=n(637)
...
function E(e){return"[object RegExp]"===Object.prototype.toString.call(e)}class D{constructor(e){this.find=e.find,this.handler=e.handler}}const A=(e,t)=>{if(E(t))return t.exec(e)
const n=t(e)
if(!n)return null
const r=[n.text]
...
null!==e.handler({state:l,range:p,match:t,commands:m,chain:v,can:y})&&s.steps.length&&(s.setMeta(a,{transform:s,from:r,to:o,text:i}),c.dispatch(s),f=!0)})),f}function R(e){const{editor:t,rules:n}=e,o=new r.Plugin({state:{init:()=>null,apply(e,r){const i=e.getMeta(o)
if(i)return i
const s=e.getMeta("applyInputRules")
return!!s&&setTimeout((()=>{const{from:e,text:r}=s,i=e+r.length
P({editor:t,from:e,to:i,text:r,rules:n,plugin:o})})),e.selectionSet||e.docChanged?null:r}},props:{handleTextInput:(e,r,i,s)=>P({editor:t,from:r,to:i,text:s,rules:n,plugin:o}),handleDOMEvents:{compositionend:e=>(setTimeout((()=>{const{$cursor:r}=e.state.selection
r&&P({editor:t,from:r.pos,to:r.pos,text:"",rules:n,plugin:o})})),!1)},handleKeyDown(e,r){if("Enter"!==r.key)return!1
const{$cursor:i}=e.state.selection
return!!i&&P({editor:t,from:i.pos,to:i.pos,text:"\n",rules:n,plugin:o})}},isInputRules:!0})
return o}function I(e){return"number"==typeof e}class j{constructor(e){this.find=e.find,this.handler=e.handler}}function z(e){const{editor:t,rules:n}=e
...
const l=({state:e,from:n,to:r,rule:o,pasteEvt:i})=>{const s=e.tr,l=u({state:e,transaction:s}),f=function(e){const{editor:t,state:n,from:r,to:o,rule:i,pasteEvent:s,dropEvent:a}=e,{commands:c,chain:l,can:u}=new d({editor:t,state:n}),f=[]
...
f.push(h)}))})),f.every((e=>null!==e))}({editor:t,state:l,from:Math.max(n-1,0),to:r.b-1,rule:o,pasteEvent:i,dropEvent:c})
if(f&&s.steps.length)return c="undefined"!=typeof DragEvent?new DragEvent("drop"):null,a="undefined"!=typeof ClipboardEvent?new ClipboardEvent("paste"):null,s},f=n.map((e=>new r.Plugin({view(e){const t=t=>{var n
...
return I(h)&&p&&h!==p.b?l({rule:e,state:r,from:h,to:p,pasteEvt:a}):void 0}})))
return f}function B(e){const t=e.filter(((t,n)=>e.indexOf(t)!==n))
return Array.from(new Set(t))}class F{constructor(e,t){this.splittableMarks=[],this.editor=t,this.extensions=F.resolve(e),this.schema=M(this.extensions,t),this.setupExtensions()}static resolve(e){const t=F.sort(F.flatten(e)),n=B(t.map((e=>e.name)))
...
return n?{...e,...n()}:e}),{})}get plugins(){const{editor:e}=this,t=F.sort([...this.extensions].reverse()),n=[],r=[],o=t.map((t=>{const o={name:t.name,options:t.options,storage:t.storage,editor:e,type:C(t.name,this.schema)},s=[],a=h(t,"addKeyboardShortcuts",o)
let c={}
if("mark"===t.type&&h(t,"exitable",o)&&(c.ArrowRight=()=>Be.handleExit({editor:e,mark:t})),a){const t=Object.fromEntries(Object.entries(a()).map((([t,n])=>[t,()=>n({editor:e})])))
...
return[R({editor:e,rules:n}),...z({editor:e,rules:r}),...o]}get attributes(){return m(this.extensions)}get nodeViews(){const{editor:e}=this,{nodeExtensions:t}=p(this.extensions)
...
r&&this.editor.on("beforeCreate",r),o&&this.editor.on("create",o),i&&this.editor.on("update",i),s&&this.editor.on("selectionUpdate",s),a&&this.editor.on("transaction",a),c&&this.editor.on("focus",c),l&&this.editor.on("blur",l),u&&this.editor.on("destroy",u)}))}}function $(e){return"Object"===function(e){return Object.prototype.toString.call(e).slice(8,-1)}(e)&&e.constructor===Object&&Object.getPrototypeOf(e)===Object.prototype}function V(e,t){const n={...e}
return $(e)&&$(t)&&Object.keys(t).forEach((r=>{$(t[r])&&$(e[r])?n[r]=V(e[r],t[r]):n[r]=t[r]})),n}class _{constructor(e={}){this.type="extension",this.name="extension",this.parent=null,this.child=null,this.config={name:this.name,defaultOptions:{}},this.config={...this.config,...e},this.name=this.config.name,e.defaultOptions&&Object.keys(e.defaultOptions).length>0&&console.warn(`[tiptap warn]: BREAKING CHANGE: "defaultOptions" is deprecated. Please use "addOptions" instead. Found in extension: "${this.name}".`),this.options=this.config.defaultOptions,this.config.addOptions&&(this.options=b(h(this,"addOptions",{name:this.name}))),this.storage=b(h(this,"addStorage",{name:this.name,options:this.options}))||{}}static create(e={}){return new _(e)}configure(e={}){const t=this.extend({...this.config,addOptions:()=>V(this.options,e)})
return t.name=this.name,t.parent=this.parent,t}extend(e={}){const t=new _({...this.config,...e})
return t.parent=this,this.child=t,t.name=e.name?e.name:t.parent.name,e.defaultOptions&&Object.keys(e.defaultOptions).length>0&&console.warn(`[tiptap warn]: BREAKING CHANGE: "defaultOptions" is deprecated. Please use "addOptions" instead. Found in extension: "${t.name}".`),t.options=b(h(t,"addOptions",{name:t.name})),t.storage=b(h(t,"addStorage",{name:t.name,options:t.options})),t}}function L(e,t,n){const{from:r,to:o}=t,{blockSeparator:i="\n\n",textSerializers:s={}}=n||{}
let a=""
...
e.isText&&(a+=null===(u=null==e?void 0:e.text)||void 0===u?void 0:u.slice(Math.max(r,n)-n,o-n))})),a}function J(e){return Object.fromEntries(Object.entries(e.nodes).filter((([,e])=>e.spec.toText)).map((([e,t])=>[e,t.spec.toText])))}const W=_.create({name:"clipboardTextSerializer",addOptions:()=>({blockSeparator:void 0}),addProseMirrorPlugins(){return[new r.Plugin({key:new r.PluginKey("clipboardTextSerializer"),props:{clipboardTextSerializer:()=>{const{editor:e}=this,{state:t,schema:n}=e,{doc:r,selection:o}=t,{ranges:i}=o,s=Math.min(...i.map((e=>e.$from.pos))),a=Math.max(...i.map((e=>e.$to.pos))),c=J(n)
return L(r,{from:s,to:a},{...void 0!==this.options.blockSeparator?{blockSeparator:this.options.blockSeparator}:{},textSerializers:c})}}})]}})
function q(e,t,n={strict:!0}){const r=Object.keys(t)
return!r.length||r.every((r=>n.strict?t[r]===e[r]:E(t[r])?t[r].test(e[r]):t[r]===e[r]))}function K(e,t,n={}){return e.find((e=>e.type===t&&q(e.attrs,n)))}function H(e,t,n={}){return!!K(e,t,n)}function U(e,t,n={}){if(!e||!t)return
let r=e.parent.childAfter(e.parentOffset)
if(e.parentOffset===r.offset&&0!==r.offset&&(r=e.parent.childBefore(e.parentOffset)),!r.node)return
const o=K([...r.node.marks],t,n)
if(!o)return
let i=r.index,s=e.start()+r.offset,a=i+1,c=s+r.node.nodeSize
for(K([...r.node.marks],t,n);i>0&&o.isInSet(e.parent.child(i-1).marks);)i-=1,s-=e.parent.child(i).nodeSize
for(;a<e.parent.childCount&&H([...e.parent.child(a).marks],t,n);)c+=e.parent.child(a).nodeSize,a+=1
return{from:s,to:c}}function G(e,t){if("string"==typeof e){if(!t.marks[e])throw Error(`There is no mark type named '${e}'. Maybe you forgot to add the extension?`)
return t.marks[e]}return e}function X(e){return e instanceof r.TextSelection}function Y(e=0,t=0,n=0){return Math.min(Math.max(e,t),n)}function Q(e,t=null){if(!t)return null
const n=r.Selection.atStart(e),o=r.Selection.atEnd(e)
if("start"===t||!0===t)return n
if("end"===t)return o
const i=n.from,s=o.to
return"all"===t?r.TextSelection.create(e,Y(0,i,s),Y(e.content.size,i,s)):r.TextSelection.create(e,Y(t,i,s),Y(t,i,s))}function Z(){return["iPad Simulator","iPhone Simulator","iPod Simulator","iPad","iPhone","iPod"].includes(navigator.platform)||navigator.userAgent.includes("Mac")&&"ontouchend"in document}const ee=e=>{const t=e.childNodes
for(let n=t.length-1;n>=0;n-=1){const r=t[n]
3===r.nodeType&&r.nodeValue&&/^(\n\s\s|\n)$/.test(r.nodeValue)?e.removeChild(r):1===r.nodeType&&ee(r)}return e}
function te(e){const t=`<body>${e}</body>`,n=(new window.DOMParser).parseFromString(t,"text/html").body
return ee(n)}function ne(e,t,n){n={slice:!0,parseOptions:{},...n}
...
return console.warn("[tiptap warn]: Invalid content.","Passed value:",e,"Error:",r),ne("",t,n)}if(r){if(n.errorOnInvalidContent){let r=!1,o=""
...
if(n.slice?s.DOMParser.fromSchema(i).parseSlice(te(e),n.parseOptions):s.DOMParser.fromSchema(i).parse(te(e),n.parseOptions),n.errorOnInvalidContent&&r)throw new Error("[tiptap error]: Invalid HTML content",{cause:new Error(`Invalid element found: ${o}`)})}const r=s.DOMParser.fromSchema(t)
return n.slice?r.parseSlice(te(e),n.parseOptions).content:r.parse(te(e),n.parseOptions)}return ne("",t,n)}function re(e,t,n){const o=e.steps.length-1
if(o<t)return
const i=e.steps[o]
if(!(i instanceof a.ReplaceStep||i instanceof a.ReplaceAroundStep))return
const s=e.mapping.maps[o]
let c=0
s.forEach(((e,t,n,r)=>{0===c&&(c=r)})),e.setSelection(r.Selection.near(e.doc.resolve(c),n))}function oe(){return"undefined"!=typeof navigator&&/Mac/.test(navigator.platform)}function ie(e,t,n={}){const{from:r,to:o,empty:i}=e.selection,s=t?v(t,e.schema):null,a=[]
e.doc.nodesBetween(r,o,((e,t)=>{if(e.isText)return
const n=Math.max(r,t),i=Math.min(o,t+e.nodeSize)
a.push({node:e,from:n,to:i})}))
const c=o-r,l=a.filter((e=>!s||s.name===e.node.type.name)).filter((e=>q(e.node.attrs,n,{strict:!1})))
return i?!!l.length:l.reduce(((e,t)=>e+t.to-t.from),0)>=c}function se(e,t){return t.nodes[e]?"node":t.marks[e]?"mark":null}function ae(e,t){const n="string"==typeof t?[t]:t
return Object.keys(e).reduce(((t,r)=>(n.includes(r)||(t[r]=e[r]),t)),{})}function ce(e,t,n={},r={}){return ne(e,t,{slice:!1,parseOptions:n,errorOnInvalidContent:r.errorOnInvalidContent})}function le(e,t){const n=G(t,e.schema),{from:r,to:o,empty:i}=e.selection,s=[]
...
return a?{...a.attrs}:{}}function ue(e){for(let t=0;t<e.edgeCount;t+=1){const{type:n}=e.edge(t)
if(n.isTextblock&&!n.hasRequiredAttrs())return n}return null}function de(e,t){for(let n=e.depth;n>0;n-=1){const r=e.node(n)
if(t(r))return{pos:n>0?e.before(n):0,start:e.start(n),depth:n,node:r}}}function fe(e){return t=>de(t.$from,e)}function he(e,t){const n=s.DOMSerializer.fromSchema(t).serializeFragment(e),r=document.implementation.createHTMLDocument().createElement("div")
return r.appendChild(n),r.innerHTML}function pe(e,t){return M(F.resolve(e),t)}function me(e,t){return L(e,{from:0,to:e.content.size},t)}function ve(e,t){const n=v(t,e.schema),{from:r,to:o}=e.selection,i=[]
e.doc.nodesBetween(r,o,(e=>{i.push(e)}))
const s=i.reverse().find((e=>e.type.name===n.name))
return s?{...s.attrs}:{}}function ye(e,t){const n=se("string"==typeof t?t:t.name,e.schema)
return"node"===n?ve(e,t):"mark"===n?le(e,t):{}}function ge(e,t=JSON.stringify){const n={}
return e.filter((e=>{const r=t(e)
return!Object.prototype.hasOwnProperty.call(n,r)&&(n[r]=!0)}))}function ke(e,t,n){const r=[]
return e===t?n.resolve(e).marks().forEach((t=>{const o=U(n.resolve(e),t.type)
o&&r.push({mark:t,...o})})):n.nodesBetween(e,t,((e,t)=>{e&&void 0!==(null==e?void 0:e.nodeSize)&&r.push(...e.marks.map((n=>({from:t,to:t+e.nodeSize,mark:n}))))})),r}function be(e,t,n){return Object.fromEntries(Object.entries(n).filter((([n])=>{const r=e.find((e=>e.type===t&&e.name===n))
return!!r&&r.attribute.keepOnSplit})))}function we(e,t,n={}){const{empty:r,ranges:o}=e.selection,i=t?G(t,e.schema):null
...
const c=a.filter((e=>!i||i.name===e.mark.type.name)).filter((e=>q(e.mark.attrs,n,{strict:!1}))).reduce(((e,t)=>e+t.to-t.from),0),l=a.filter((e=>!i||e.mark.type!==i&&e.mark.type.excludes(i))).reduce(((e,t)=>e+t.to-t.from),0)
return(c>0?c+l:c)>=s}function Se(e,t,n={}){if(!t)return ie(e,null,n)||we(e,null,n)
const r=se(t,e.schema)
return"node"===r?ie(e,t,n):"mark"===r&&we(e,t,n)}function xe(e,t){const{nodeExtensions:n}=p(t),r=n.find((t=>t.name===e))
if(!r)return!1
const o=b(h(r,"group",{name:r.name,options:r.options,storage:r.storage}))
return"string"==typeof o&&o.split(" ").includes("list")}function Oe(e,{checkChildren:t=!0,ignoreWhitespace:n=!1}={}){var r
...
if(t){let r=!0
return e.content.forEach((e=>{!1!==r&&(Oe(e,{ignoreWhitespace:n,checkChildren:t})||(r=!1))})),r}return!1}function Me(e,t){const n=e.storedMarks||e.selection.$to.parentOffset&&e.selection.$from.marks()
if(n){const r=n.filter((e=>null==t?void 0:t.includes(e.type.name)))
e.tr.ensureMarks(r)}}const Ce=(e,t)=>{const n=fe((e=>e.type===t))(e.selection)
if(!n)return!0
const r=e.doc.resolve(Math.max(0,n.pos-1)).before(n.depth)
if(void 0===r)return!0
const o=e.doc.nodeAt(r)
return n.node.type!==(null==o?void 0:o.type)||!a.canJoin(e.doc,n.pos)||(e.join(n.pos),!0)},Te=(e,t)=>{const n=fe((e=>e.type===t))(e.selection)
if(!n)return!0
const r=e.doc.resolve(n.start).after(n.depth)
if(void 0===r)return!0
const o=e.doc.nodeAt(r)
return n.node.type!==(null==o?void 0:o.type)||!a.canJoin(e.doc,r)||(e.join(r),!0)}
var Ne=Object.freeze({__proto__:null,blur:()=>({editor:e,view:t})=>(requestAnimationFrame((()=>{var n
...
return n&&t.delete(r,o),!0},deleteSelection:()=>({state:e,dispatch:t})=>c.deleteSelection(e,t),enter:()=>({commands:e})=>e.keyboardShortcut("Enter"),exitCode:()=>({state:e,dispatch:t})=>c.exitCode(e,t),extendMarkRange:(e,t={})=>({tr:n,state:o,dispatch:i})=>{const s=G(e,o.schema),{doc:a,selection:c}=n,{$from:l,from:u,to:d}=c
if(i){const e=U(l,s,t)
...
const s=()=>{Z()&&r.dom.focus(),requestAnimationFrame((()=>{n.isDestroyed||(r.focus(),(null==t?void 0:t.scrollIntoView)&&n.commands.scrollIntoView())}))}
if(r.hasFocus()&&null===e||!1===e)return!0
if(i&&null===e&&!X(n.state.selection))return s(),!0
const a=Q(o.doc,e)||n.state.selection,c=n.state.selection.eq(a)
...
Z()||oe()?i=!0:r=!0}}return n&&(s=`Alt-${s}`),r&&(s=`Ctrl-${s}`),i&&(s=`Meta-${s}`),o&&(s=`Shift-${s}`),s}(e).split(/-(?!$)/),s=i.find((e=>!["Alt","Ctrl","Meta","Shift"].includes(e))),a=new KeyboardEvent("keydown",{key:"Space"===s?" ":s,altKey:i.includes("Alt"),ctrlKey:i.includes("Ctrl"),metaKey:i.includes("Meta"),shiftKey:i.includes("Shift"),bubbles:!0,cancelable:!0}),c=t.captureTransaction((()=>{n.someProp("handleKeyDown",(e=>e(n,a)))}))
return null==c||c.steps.forEach((e=>{const t=e.map(r.mapping)
t&&o&&r.maybeStep(t)})),!0},lift:(e,t={})=>({state:n,dispatch:r})=>!!ie(n,v(e,n.schema),t)&&c.lift(n,r),liftEmptyBlock:()=>({state:e,dispatch:t})=>c.liftEmptyBlock(e,t),liftListItem:e=>({state:t,dispatch:n})=>{const r=v(e,t.schema)
...
const{selection:o}=t
let i=null
if(X(o)&&(i=o.$cursor),i){const t=null!==(r=e.storedMarks)&&void 0!==r?r:i.marks()
...
return i.isTextblock?o().command((({commands:e})=>!!c.setBlockType(i,t)(n)||e.clearNodes())).command((({state:e})=>c.setBlockType(i,t)(e,r))).run():(console.warn('[tiptap warn]: Currently "setNode()" only supports text block nodes.'),!1)},setNodeSelection:e=>({tr:t,dispatch:n})=>{if(n){const{doc:n}=t,o=Y(e,0,n.content.size),i=r.NodeSelection.create(n,o)
t.setSelection(i)}return!0},setTextSelection:e=>({tr:t,dispatch:n})=>{if(n){const{doc:n}=t,{from:o,to:i}="number"==typeof e?{from:e,to:e}:e,s=r.TextSelection.atStart(n).from,a=r.TextSelection.atEnd(n).to,c=Y(o,s,a),l=Y(i,s,a),u=r.TextSelection.create(n,c,l)
t.setSelection(u)}return!0},sinkListItem:e=>({state:t,dispatch:n})=>{const r=v(e,t.schema)
return l.sinkListItem(r)(t,n)},splitBlock:({keepMarks:e=!0}={})=>({tr:t,state:n,dispatch:o,editor:i})=>{const{selection:s,doc:c}=t,{$from:l,$to:u}=s,d=be(i.extensionManager.attributes,l.node().type.name,l.node().attrs)
if(s instanceof r.NodeSelection&&s.node.isBlock)return!(!l.parentOffset||!a.canSplit(c,l.pos)||(o&&(e&&Me(n,i.extensionManager.splittableMarks),t.split(l.pos).scrollIntoView()),0))
if(!l.parent.isBlock)return!1
const f=u.parentOffset===u.parent.content.size,h=0===l.depth?void 0:ue(l.node(-1).contentMatchAt(l.indexAfter(-1)))
...
l.node(-1).canReplaceWith(n.index(),n.index()+1,h)&&t.setNodeMarkup(t.mapping.map(l.before()),h)}e&&Me(n,i.extensionManager.splittableMarks),t.scrollIntoView()}return m},splitListItem:(e,t={})=>({tr:n,state:o,dispatch:i,editor:c})=>{var l
...
const i=d.indexAfter(-1)<d.node(-2).childCount?1:d.indexAfter(-2)<d.node(-3).childCount?2:3,a={...be(m,d.node().type.name,d.node().attrs),...t},c=(null===(l=u.contentMatch.defaultType)||void 0===l?void 0:l.createAndFill(a))||void 0
...
e.isTextblock&&0===e.content.size&&(h=t+1)})),h>-1&&n.setSelection(r.TextSelection.near(n.doc.resolve(h))),n.scrollIntoView()}return!0}const y=f.pos===d.end()?p.contentMatchAt(0).defaultType:null,g={...be(m,p.type.name,p.attrs),...t},k={...be(m,d.node().type.name,d.node().attrs),...t}
...
if(!b)return!1
const S=fe((e=>xe(e.type.name,d)))(m)
if(b.depth>=1&&S&&b.depth-S.depth<=1){if(S.node.type===h)return l.liftListItem(p)
if(xe(S.node.type.name,d)&&h.validContent(S.node.content)&&a)return c().command((()=>(i.setNodeMarkup(S.pos,h),!0))).command((()=>Ce(i,h))).command((()=>Te(i,h))).run()}return n&&w&&a?c().command((()=>{const e=u().wrapInList(h,r),t=w.filter((e=>f.includes(e.type.name)))
return i.ensureMarks(t),!!e||l.clearNodes()})).wrapInList(h,r).command((()=>Ce(i,h))).command((()=>Te(i,h))).run():c().command((()=>!!u().wrapInList(h,r)||l.clearNodes())).wrapInList(h,r).command((()=>Ce(i,h))).command((()=>Te(i,h))).run()},toggleMark:(e,t={},n={})=>({state:r,commands:o})=>{const{extendEmptyMarkRange:i=!1}=n,s=G(e,r.schema)
return we(r,s,t)?o.unsetMark(s,{extendEmptyMarkRange:i}):o.setMark(s,t)},toggleNode:(e,t,n={})=>({state:r,commands:o})=>{const i=v(e,r.schema),s=v(t,r.schema)
return ie(r,i,n)?o.setNode(s):o.setNode(i,n)},toggleWrap:(e,t={})=>({state:n,commands:r})=>{const o=v(e,n.schema)
return ie(n,o,t)?r.lift(o):r.wrapIn(o,t)},undoInputRule:()=>({state:e,dispatch:t})=>{const n=e.plugins
...
const{extendEmptyMarkRange:s=!1}=t,{selection:a}=n,c=G(e,r.schema),{$from:l,empty:u,ranges:d}=a
if(!o)return!0
if(u&&s){let{from:e,to:t}=a
const r=null===(i=l.marks().find((e=>e.type===c)))||void 0===i?void 0:i.attrs,o=U(l,c,r)
...
const a=se("string"==typeof e?e:e.name,r.schema)
return!!a&&("node"===a&&(i=v(e,r.schema)),"mark"===a&&(s=G(e,r.schema)),o&&n.selection.ranges.forEach((e=>{const o=e.$from.pos,a=e.$to.pos
...
const Ee=_.create({name:"commands",addCommands:()=>({...Ne})}),De=_.create({name:"editable",addProseMirrorPlugins(){return[new r.Plugin({key:new r.PluginKey("editable"),props:{editable:()=>this.editor.options.editable}})]}}),Ae=_.create({name:"focusEvents",addProseMirrorPlugins(){const{editor:e}=this
...
return Z()||oe()?i:o},addProseMirrorPlugins(){return[new r.Plugin({key:new r.PluginKey("clearDocument"),appendTransaction:(e,t,n)=>{if(!e.some((e=>e.docChanged))||t.doc.eq(n.doc))return
...
return h.clearNodes(),l.steps.length?l:void 0}})]}}),Re=_.create({name:"tabindex",addProseMirrorPlugins(){return[new r.Plugin({key:new r.PluginKey("tabindex"),props:{attributes:()=>this.editor.isEditable?{tabindex:"0"}:{}}})]}})
var Ie=Object.freeze({__proto__:null,ClipboardTextSerializer:W,Commands:Ee,Editable:De,FocusEvents:Ae,Keymap:Pe,Tabindex:Re})
class je{get name(){return this.node.type.name}constructor(e,t,n=!1,r=null){this.currentNode=null,this.actualDepth=null,this.isBlock=n,this.resolvedPos=e,this.editor=t,this.currentNode=r}get node(){return this.currentNode||this.resolvedPos.node()}get element(){return this.editor.view.domAtPos(this.pos).node}get depth(){var e
...
return new je(t,this.editor)}get before(){let e=this.resolvedPos.doc.resolve(this.from-(this.isBlock?1:2))
return e.depth!==this.depth&&(e=this.resolvedPos.doc.resolve(this.from-3)),new je(e,this.editor)}get after(){let e=this.resolvedPos.doc.resolve(this.to+(this.isBlock?2:1))
return e.depth!==this.depth&&(e=this.resolvedPos.doc.resolve(this.to+3)),new je(e,this.editor)}get children(){const e=[]
...
const s=new je(i,this.editor,r,r?t:null)
r&&(s.actualDepth=this.depth+1),e.push(new je(i,this.editor,r,r?t:null))})),e}get firstChild(){return this.children[0]||null}get lastChild(){const e=this.children
...
this.editor.chain().setTextSelection(this.from).updateAttributes(this.node.type.name,e).setTextSelection(t.from).run()}}function ze(e,t,n){const r=document.querySelector(`style[data-tiptap-style${n?`-${n}`:""}]`)
if(null!==r)return r
const o=document.createElement("style")
return t&&o.setAttribute("nonce",t),o.setAttribute("data-tiptap-style"+(n?`-${n}`:""),""),o.innerHTML=e,document.getElementsByTagName("head")[0].appendChild(o),o}class Be{constructor(e={}){this.type="mark",this.name="mark",this.parent=null,this.child=null,this.config={name:this.name,defaultOptions:{}},this.config={...this.config,...e},this.name=this.config.name,e.defaultOptions&&Object.keys(e.defaultOptions).length>0&&console.warn(`[tiptap warn]: BREAKING CHANGE: "defaultOptions" is deprecated. Please use "addOptions" instead. Found in extension: "${this.name}".`),this.options=this.config.defaultOptions,this.config.addOptions&&(this.options=b(h(this,"addOptions",{name:this.name}))),this.storage=b(h(this,"addStorage",{name:this.name,options:this.options}))||{}}static create(e={}){return new Be(e)}configure(e={}){const t=this.extend({...this.config,addOptions:()=>V(this.options,e)})
...
const n=[...this.options.enableCoreExtensions?[De,W.configure({blockSeparator:null===(t=null===(e=this.options.coreExtensionOptions)||void 0===e?void 0:e.clipboardTextSerializer)||void 0===t?void 0:t.blockSeparator}),Ee,Ae,Pe,Re]:[],...this.options.extensions].filter((e=>["extension","node","mark"].includes(null==e?void 0:e.type)))
this.extensionManager=new F(n,this)}createCommandManager(){this.commandManager=new d({editor:this})}createSchema(){this.schema=this.extensionManager.schema}createView(){let e
try{e=ce(this.options.content,this.schema,this.options.parseOptions,{errorOnInvalidContent:this.options.enableContentCheck})}catch(t){if(!(t instanceof Error&&["[tiptap error]: Invalid JSON content","[tiptap error]: Invalid HTML content"].includes(t.message)))throw t
this.emit("contentError",{editor:this,error:t,disableCollaboration:()=>{this.options.extensions=this.options.extensions.filter((e=>"collaboration"!==e.name)),this.createExtensionManager()}}),e=ce(this.options.content,this.schema,this.options.parseOptions,{errorOnInvalidContent:!1})}const t=Q(e,this.options.autofocus)
...
r&&this.emit("focus",{editor:this,event:r.event,transaction:e}),o&&this.emit("blur",{editor:this,event:o.event,transaction:e}),e.docChanged&&!e.getMeta("preventUpdate")&&this.emit("update",{editor:this,transaction:e})}getAttributes(e){return ye(this.state,e)}isActive(e,t){const n="string"==typeof e?e:null,r="string"==typeof e?t:e
return Se(this.state,n,r)}getJSON(){return this.state.doc.toJSON()}getHTML(){return he(this.state.doc.content,this.schema)}getText(e){const{blockSeparator:t="\n\n",textSerializers:n={}}=e||{}
return me(this.state.doc,{blockSeparator:t,textSerializers:{...J(this.schema),...n}})}get isEmpty(){return Oe(this.state.doc)}getCharacterCount(){return console.warn('[tiptap warn]: "editor.getCharacterCount()" is deprecated. Please use "editor.storage.characterCount.characters()" instead.'),this.state.doc.content.size-2}destroy(){this.emit("destroy"),this.view&&this.view.destroy(),this.removeAllListeners()}get isDestroyed(){var e
...
return new je(t,this)}get $doc(){return this.$pos(0)}},t.Extension=_,t.InputRule=D,t.Mark=Be,t.Node=Fe,t.NodePos=je,t.NodeView=class{constructor(e,t,n){this.isDragging=!1,this.component=e,this.editor=t.editor,this.options={stopEvent:null,ignoreMutation:null,...n},this.extension=t.extension,this.node=t.node,this.decorations=t.decorations,this.getPos=t.getPos,this.mount()}mount(){}get dom(){return this.editor.view.dom}get contentDOM(){return null}onDragStart(e){var t,n,o,i,s,a,c
...
this.editor.commands.deleteRange({from:e,to:t})}},t.PasteRule=j,t.Tracker=class{constructor(e){this.transaction=e,this.currentStep=this.transaction.steps.length}map(e){let t=!1
...
return t.forEach((e=>{e.steps.forEach((e=>{n.step(e)}))})),n},t.createChainableState=u,t.createDocument=ce,t.createNodeFromContent=ne,t.createStyleTag=ze,t.defaultBlockAt=ue,t.deleteProps=ae,t.elementFromString=te,t.escapeForRegEx=function(e){return e.replace(/[-/\\^$*+?.()|[\]{}]/g,"\\$&")},t.extensions=Ie,t.findChildren=function(e,t){const n=[]
return e.descendants(((e,r)=>{t(e)&&n.push({node:e,pos:r})})),n},t.findChildrenInRange=function(e,t,n){const r=[]
return e.nodesBetween(t.from,t.to,((e,t)=>{n(e)&&r.push({node:e,pos:t})})),r},t.findDuplicates=B,t.findParentNode=fe,t.findParentNodeClosestToPos=de,t.fromString=S,t.generateHTML=function(e,t){const n=pe(t)
return he(s.Node.fromJSON(n,e).content,n)},t.generateJSON=function(e,t){const n=pe(t),r=te(e)
return s.DOMParser.fromSchema(n).parse(r).toJSON()},t.generateText=function(e,t,n){const{blockSeparator:r="\n\n",textSerializers:o={}}=n||{},i=pe(t)
return me(s.Node.fromJSON(i,e),{blockSeparator:r,textSerializers:{...J(i),...o}})},t.getAttributes=ye,t.getAttributesFromExtensions=m,t.getChangedRanges=function(e){const{mapping:t,steps:n}=e,r=[]
...
r.push({oldRange:{from:a,to:c},newRange:{from:i,to:s}})}))})),function(e){const t=ge(e)
...
null===(i=c.content)||void 0===i||i.push(e(t,n+o+r))}))),t.text&&(c.text=t.text),c},t.getExtensionField=h,t.getHTMLFromFragment=he,t.getMarkAttributes=le,t.getMarkRange=U,t.getMarkType=G,t.getMarksBetween=ke,t.getNodeAtPosition=(e,t,n,r=20)=>{const o=e.doc.resolve(n)
let i=r,s=null
for(;i>0&&null===s;){const e=o.node(i);(null==e?void 0:e.type.name)===t?s=e:i-=1}return[s,i]},t.getNodeAttributes=ve,t.getNodeType=v,t.getRenderedAttributes=g,t.getSchema=pe,t.getSchemaByResolvedExtensions=M,t.getSchemaTypeByName=C,t.getSchemaTypeNameByName=se,t.getSplittedAttributes=be,t.getText=me,t.getTextBetween=L,t.getTextContentFromNodes=N,t.getTextSerializersFromSchema=J,t.injectExtensionAttributesToParseRule=x,t.inputRulesPlugin=R,t.isActive=Se,t.isAtEndOfNode=(e,t)=>{const{$from:n,$to:r,$anchor:o}=e.selection
if(t){const n=fe((e=>e.type.name===t))(e.selection)
if(!n)return!1
...
return!(t.parentOffset>0||t.pos!==n.pos)},t.isEmptyObject=w,t.isExtensionRulesEnabled=T,t.isFunction=k,t.isList=xe,t.isMacOS=oe,t.isMarkActive=we,t.isNodeActive=ie,t.isNodeEmpty=Oe,t.isNodeSelection=function(e){return e instanceof r.NodeSelection},t.isNumber=I,t.isPlainObject=$,t.isRegExp=E,t.isString=function(e){return"string"==typeof e},t.isTextSelection=X,t.isiOS=Z,t.markInputRule=function(e){return new D({find:e.find,handler:({state:t,range:n,match:r})=>{const o=b(e.getAttributes,void 0,r)
...
i.addMark(n.from+r,u,e.type.create(o||{})),i.removeStoredMark(e.type)}}})},t.markPasteRule=function(e){return new j({find:e.find,handler:({state:t,range:n,match:r,pasteEvent:o})=>{const i=b(e.getAttributes,void 0,r,o)
if(!1===i||null===i)return null
const{tr:s}=t,a=r[r.length-1],c=r[0]
let l=n.to
if(a){const r=c.search(/\S/),o=n.from+c.indexOf(a),u=o+a.length
if(ke(n.from,n.to,t.doc).filter((t=>t.mark.type.excluded.find((n=>n===e.type&&n!==t.mark.type)))).filter((e=>e.to>o)).length)return null
u<n.to&&s.delete(u,n.to),o>n.from&&s.delete(n.from+r,o),l=n.from+r+a.length,s.addMark(n.from+r,l,e.type.create(i||{})),s.removeStoredMark(e.type)}}})},t.mergeAttributes=y,t.mergeDeep=V,t.minMax=Y,t.nodeInputRule=function(e){return new D({find:e.find,handler:({state:t,range:n,match:r})=>{const o=b(e.getAttributes,void 0,r)||{},{tr:i}=t,s=n.from
let a=n.to
...
i.insert(t,e.type.create(o)).delete(i.mapping.map(s),i.mapping.map(a))}i.scrollIntoView()}})},t.nodePasteRule=function(e){return new j({find:e.find,handler({match:t,chain:n,range:r,pasteEvent:o}){const i=b(e.getAttributes,void 0,t,o),s=b(e.getContent,void 0,i)
if(!1===i||null===i)return null
const a={type:e.type.name,attrs:i}
s&&(a.content=s),t.input&&n().deleteRange(r).insertContentAt(r.from,a)}})},t.objectIncludes=q,t.pasteRulesPlugin=z,t.posToDOMRect=function(e,t,n){const r=e.state.doc.content.size,o=Y(t,0,r),i=Y(n,0,r),s=e.coordsAtPos(o),a=e.coordsAtPos(i,-1),c=Math.min(s.top,a.top),l=Math.max(s.bottom,a.bottom),u=Math.min(s.left,a.left),d=Math.max(s.right,a.right),f={top:c,bottom:l,left:u,right:d,width:d-u,height:l-c,x:u,y:c}
return{...f,toJSON:()=>f}},t.removeDuplicates=ge,t.resolveFocusPosition=Q,t.selectionToInsertionEnd=re,t.splitExtensions=p,t.textInputRule=function(e){return new D({find:e.find,handler:({state:t,range:n,match:r})=>{let o=e.replace,i=n.from
const s=n.to
if(r[1]){const e=r[0].lastIndexOf(r[1])
o+=r[0].slice(e+r[1].length),i+=e
const t=i-s
t>0&&(o=r[0].slice(e-t,e)+o,i=s)}t.tr.insertText(o,i,s)}})},t.textPasteRule=function(e){return new j({find:e.find,handler:({state:t,range:n,match:r})=>{let o=e.replace,i=n.from
const s=n.to
if(r[1]){const e=r[0].lastIndexOf(r[1])
o+=r[0].slice(e+r[1].length),i+=e
const t=i-s
...
u&&u.type===e.type&&a.canJoin(s.doc,n.from-1)&&(!e.joinPredicate||e.joinPredicate(r,u))&&s.join(n.from-1)}})}},430:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0})
const r=n(248).Node.create({name:"doc",topNode:!0,content:"block+"})
t.Document=r,t.default=r},400:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0})
var r=n(248),o=n(938)
...
t.Gapcursor=i,t.default=i},689:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0})
var r=n(248),o=n(223)
...
t.History=i,t.default=i},67:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0})
var r=n(248)
...
t.Paragraph=o,t.default=o},976:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0})
const r=n(248).Node.create({name:"text",group:"inline"})
t.Text=r,t.default=r},675:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0})
var r,o=n(449)
r=o,Object.keys(r).filter((e=>"default"!==e&&"__esModule"!==e)).forEach((e=>{t.hasOwnProperty(e)||Object.defineProperty(t,e,{enumerable:!0,configurable:!0,get:()=>r[e]})}))},938:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0})
var r,o=n(788)
r=o,Object.keys(r).filter((e=>"default"!==e&&"__esModule"!==e)).forEach((e=>{t.hasOwnProperty(e)||Object.defineProperty(t,e,{enumerable:!0,configurable:!0,get:()=>r[e]})}))},769:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0})
var r,o=n(459)
...
var r,o=n(669)
r=o,Object.keys(r).filter((e=>"default"!==e&&"__esModule"!==e)).forEach((e=>{t.hasOwnProperty(e)||Object.defineProperty(t,e,{enumerable:!0,configurable:!0,get:()=>r[e]})}))},470:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0})
var r,o=n(136)
r=o,Object.keys(r).filter((e=>"default"!==e&&"__esModule"!==e)).forEach((e=>{t.hasOwnProperty(e)||Object.defineProperty(t,e,{enumerable:!0,configurable:!0,get:()=>r[e]})}))},106:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0})
var r,o=n(712)
...
var r,o=n(243)
r=o,Object.keys(r).filter((e=>"default"!==e&&"__esModule"!==e)).forEach((e=>{t.hasOwnProperty(e)||Object.defineProperty(t,e,{enumerable:!0,configurable:!0,get:()=>r[e]})}))},614:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0})
var r,o=n(820)
r=o,Object.keys(r).filter((e=>"default"!==e&&"__esModule"!==e)).forEach((e=>{t.hasOwnProperty(e)||Object.defineProperty(t,e,{enumerable:!0,configurable:!0,get:()=>r[e]})}))},175:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0})
var r,o=n(553)
r=o,Object.keys(r).filter((e=>"default"!==e&&"__esModule"!==e)).forEach((e=>{t.hasOwnProperty(e)||Object.defineProperty(t,e,{enumerable:!0,configurable:!0,get:()=>r[e]})}))},392:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0})
var r,o=n(454)
r=o,Object.keys(r).filter((e=>"default"!==e&&"__esModule"!==e)).forEach((e=>{t.hasOwnProperty(e)||Object.defineProperty(t,e,{enumerable:!0,configurable:!0,get:()=>r[e]})}))},717:e=>{function t(e){this.content=e}t.prototype={constructor:t,find:function(e){for(var t=0;t<this.content.length;t+=2)if(this.content[t]===e)return t
...
return new t(n)},e.exports=t},449:(e,t,n)=>{var r=n(553),o=n(712),i=n(820),s=function(e,t){return!e.selection.empty&&(t&&t(e.tr.deleteSelection().scrollIntoView()),!0)}
...
return!!l&&(o&&o(n.tr.wrap(c,l).scrollIntoView()),!0)}}},788:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0})
...
return new r.Plugin({view:function(t){return new i(t,e)}})}},459:(e,t,n)=>{function r(e){return r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},r(e)}function o(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function i(e,t){for(var n=0;n<t.length;n++){var r=t[n]
...
return t.className="ProseMirror-gapcursor",f.DecorationSet.create(e.doc,[f.Decoration.widget(e.selection.head,t,{key:"gapcursor"})])}t.GapCursor=h,t.gapCursor=function(){return new u.Plugin({props:{decorations:k,createSelectionBetween:function(e,t,n){return t.pos==n.pos&&h.valid(n)?new h(n):null},handleClick:y,handleKeyDown:m,handleDOMEvents:{beforeinput:g}}})}},669:(e,t,n)=>{function r(e){return r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},r(e)}function o(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function i(e,t){for(var n=0;n<t.length;n++){var o=t[n]
...
return t?t.done.eventCount:0},t.undoNoScroll=O},136:(e,t,n)=>{Object.defineProperty(t,"__esModule",{value:!0})
...
if(l&&l(e.state,e.dispatch,e))return!0}}return!1}}t.keydownHandler=c,t.keymap=function(e){return new o.Plugin({props:{handleKeyDown:c(e)}})}},712:(e,t,n)=>{function r(e,t){(null==t||t>e.length)&&(t=e.length)
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,(o=function(e,t){if("object"!==f(e)||null===e)return e
var n=e[Symbol.toPrimitive]
if(void 0!==n){var r=n.call(e,"string")
...
s=g}}return{dom:c,contentDOM:s}}t.ContentMatch=K,t.DOMParser=ue,t.DOMSerializer=be,t.Fragment=k,t.Mark=x,t.MarkType=ae,t.Node=J,t.NodeRange=_,t.NodeType=ie,t.ReplaceError=O,t.ResolvedPos=B,t.Schema=ce,t.Slice=M},243:(e,t,n)=>{var r=n(553),o=n(712),i=n(820),s=["ol",0],a=["ul",0],c=["li",0],l={attrs:{order:{default:1,validate:"number"}},parseDOM:[{tag:"ol",getAttrs:function(e){return{order:e.hasAttribute("start")?+e.getAttribute("start"):1}}}],toDOM:function(e){return 1==e.attrs.order?s:["ol",{start:e.attrs.order},0]}},u={parseDOM:[{tag:"ul"}],toDOM:function(){return a}},d={parseDOM:[{tag:"li"}],toDOM:function(){return c},defining:!0}
...
return e}(n.tr,l,h,u,e).scrollIntoView()),!0)}}},820:(e,t,n)=>{function r(e){return r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},r(e)}function o(){return o="undefined"!=typeof Reflect&&Reflect.get?Reflect.get:function(e,t,n){var r=function(e,t){for(;!Object.prototype.hasOwnProperty.call(e,t)&&null!==(e=c(e)););return e}(e,t)
if(r){var o=Object.getOwnPropertyDescriptor(r,t)
return o.get?o.get.call(arguments.length<3?e:n):o.value}},o.apply(this,arguments)}function i(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function")
...
t.AllSelection=x,t.EditorState=P,t.NodeSelection=w,t.Plugin=I,t.PluginKey=B,t.Selection=m,t.SelectionRange=v,t.TextSelection=k,t.Transaction=T},553:(e,t,n)=>{function r(e){var t="function"==typeof Map?new Map:void 0
...
r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,(o=function(e,t){if("object"!==u(e)||null===e)return e
var n=e[Symbol.toPrimitive]
if(void 0!==n){var r=n.call(e,"string")
...
if(0==n||r.type.spec.isolating||!P(r,o,i))break}return null},t.replaceStep=z},454:(e,t,n)=>{function r(e,t){var n="undefined"!=typeof Symbol&&e[Symbol.iterator]||e["@@iterator"]
...
return"Esc"==t&&(t="Escape"),"Del"==t&&(t="Delete"),"Left"==t&&(t="ArrowLeft"),"Up"==t&&(t="ArrowUp"),"Right"==t&&(t="ArrowRight"),"Down"==t&&(t="ArrowDown"),t},t.shift=r}}])
