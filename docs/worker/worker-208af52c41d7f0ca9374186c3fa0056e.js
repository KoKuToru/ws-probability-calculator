...
this.write_uint32(t,s)}}let module=WebAssembly.compileStreaming(fetch("engine-c532d6119409c57a1560b6d95a476868.wasm")).then((t=>{module=t}))
...
break
case"stock":i.push([t.stock,n[0]])
break
case"stockswap":i.push([t.stockswap])
break
case"stockshuffle":i.push([t.stockshuffle])
break
