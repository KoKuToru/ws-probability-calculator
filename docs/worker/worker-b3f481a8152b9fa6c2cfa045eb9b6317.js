import compiler from"./compiler-0348ebc31ed34ef318bb8ff13201847b.js"
...
this.write_uint32(t,s)}}let module=WebAssembly.compileStreaming(fetch("engine-b748986d1bd1ffc3e68e95a1a8e00c7e.wasm")).then((t=>{module=t}))
...
break
case"reveal":i.push([t.reveal,n[0]??1])
break
