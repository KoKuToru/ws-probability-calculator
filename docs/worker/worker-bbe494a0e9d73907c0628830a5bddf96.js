import compiler from"./compiler-600702cbfc0cf94e240b95947a617d67.js"
...
break
case"push":i.push([t.push,pushs[n[0]]])
break
case"check":i.push([t.check,n[0],ops[n[1]],n[2]])
break
case"flush":i.push([t.flush])}return i.push([t.dump]),i.map((([e,...i])=>e.bind(t,...i)))}self.addEventListener("message",(async t=>{module instanceof Promise&&await module
...
t.ports[0].postMessage({data:e,code:i,dmg:o,dmg_acc:c,mean:u})}catch(s){throw(s instanceof RangeError||s instanceof EngineOutOfMemory)&&(console.error(s),t.ports[0].postMessage({data:e,outofmemory:!0,error:"Out Of Memory",code:i})),s instanceof EngineError&&(console.error(s),t.ports[0].postMessage({data:e,error:s.message,code:i})),s}}))
