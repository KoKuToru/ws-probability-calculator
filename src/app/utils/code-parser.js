export const syntax = [
  ...
  { regex: /^attack\s+(cx)\s*$/g,       params: [() => 'cx'],  name: 'attack', short: 'a', need_parent: false },
  { regex: /^attack\s+(not\s+cx)\s*$/g, params: [() => 'ncx'], name: 'attack', short: 'a', need_parent: false },
  { regex: /^burn\s+([0-9]+)\s*$/g,     params: [parseInt],    name: 'burn',   short: 'b', need_parent: false },
  { regex: /^burn\s+(cx)\s*$/g,         params: [() => 'cx'],  name: 'burn',   short: 'b', need_parent: false },
  { regex: /^burn\s+(not\s+cx)\s*$/g,   params: [() => 'ncx'], name: 'burn',   short: 'b', need_parent: false },
  { regex: /^mill\s+([0-9]+)\s*$/g,     params: [parseInt],    name: 'mill',   short: 'm', need_parent: false },
  { regex: /^mill\s+(cx)\s*$/g,         params: [() => 'cx'],  name: 'mill',   short: 'm', need_parent: false },
  { regex: /^mill\s+(not\s+cx)\s*$/g,   params: [() => 'ncx'], name: 'mill',   short: 'm', need_parent: false },
  { regex: /^damage\s+([0-9]+)\s*$/g,   params: [parseInt],    name: 'damage', short: 'd', need_parent: false },
  { regex: /^damage\s+(cx)\s*$/g,       params: [() => 'cx'],  name: 'damage', short: 'd', need_parent: false },
  { regex: /^damage\s+(not cx)\s*$/g,   params: [() => 'ncx'], name: 'damage', short: 'd', need_parent: false },
